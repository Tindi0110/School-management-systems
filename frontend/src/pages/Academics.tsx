...
const Academics = () => {
    ...
    return (
        <div className="fade-in px-4">
            {/* Standard Header — matches Finance & Transport */}
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-8">
                <div className="w-full lg:w-auto">
                    <h1 className="text-3xl font-black tracking-tight">Institution Academics</h1>
                    <p className="text-secondary text-sm font-medium">
                        Classes, curriculum, exams and grading &nbsp;•&nbsp;
                        <span className="font-bold">{activeYear} &bull; {activeTerm}</span>
                    </p>
                </div>
                {!isReadOnly && (
                    <div className="flex flex-wrap gap-2 w-full lg:w-auto justify-start lg:justify-end no-print">
                        <Button variant="ghost" size="sm" className="flex-1 sm:flex-none" onClick={() => window.print()} icon={<Printer size={14} />}>Print</Button>
                        <Button variant="outline" size="sm" className="flex-1 sm:flex-none" onClick={() => setIsClassModalOpen(true)} icon={<Plus size={14} />}>Add Class</Button>
                        <Button variant="outline" size="sm" className="flex-1 sm:flex-none" onClick={() => setIsSubjectModalOpen(true)} icon={<Plus size={14} />}>New Subject</Button>
                        <Button variant="primary" size="sm" className="flex-1 sm:flex-none" onClick={() => setIsExamModalOpen(true)} icon={<Plus size={14} />}>New Exam</Button>
                    </div>
                )}
            </div>

            {/* Stat Cards Row — Finance pattern */}
                        ...
                        <div className="grid grid-cols-12 gap-6 lg:gap-8">
                            {classes.filter(cls =>
                                ...
                                <div key={cls.id} className="col-span-12 md:col-span-6 lg:col-span-4 min-w-0">
                                    <div className="card h-full flex flex-col p-6 border-top-4 border-primary">
                    ...
                    {activeTab === 'CURRICULUM' && (
                        <div className="grid grid-cols-12 gap-6 lg:gap-8">
                            <div className="col-span-12 lg:col-span-3 space-y-4 min-w-0">
                                <div className="card flex flex-col p-0 overflow-hidden border-top-4 border-primary">
                                    <div className="card-header">
                            ...
                            <div className="col-span-12 lg:col-span-9 min-w-0 fade-in card flex flex-col p-0 overflow-hidden border-top-4 border-primary">
                                <div className="card-header">
                            ...
                            <div className="col-span-12 space-y-6 lg:space-y-8 fade-in mt-8">
                                ...
                                <div className="fade-in card flex flex-col p-0 overflow-hidden border-top-4 border-primary">
                                    <div className="card-header">
                            ...
                            <div className="grid grid-cols-12 gap-6 lg:gap-8 h-[calc(100vh-250px)]">
                                ...
                                <div className="col-span-12 lg:col-span-9 min-w-0 flex flex-col">
                                    {selectedAllocationClass ? (
                                        <div className="card h-full flex flex-col min-w-0 overflow-hidden border-top-4 border-primary">
                                            <div className="card-header">
                                                <div>
...

                    {
                        activeTab === 'GRADING' && (
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-lg h-[calc(100vh-200px)]">
                                {/* Left: Systems List */}
                                <div className="card md:col-span-1 flex flex-col border-top-4 border-primary p-0 overflow-hidden">
                                    <div className="card-header flex justify-between items-center py-3 border-b border-slate-100">
                                ...
                                <div className="card md:col-span-2 flex flex-col border-top-4 border-primary p-0 overflow-hidden">
                                    {selectedSystem ? (
                                        <>
                                            <div className="card-header flex justify-between items-center py-3 border-b border-slate-100">
                                                <div>
                            ...
                            <div className="grid grid-cols-12 gap-6 lg:gap-8">
                                {exams.filter(exam =>
                                    ...
                                    <div key={exam.id} className="col-span-12 md:col-span-6 lg:col-span-4 min-w-0">
                                        <div className="card h-full flex flex-col p-6 overflow-hidden border-top-4 border-primary">
                                            <div className="flex justify-between items-start mb-4">
                                                <div className="p-2.5 rounded-lg bg-primary-light text-white"><ClipboardCheck size={16} /></div>
                        ...
                        activeTab === 'RESOURCES' && (
                            <div className="grid grid-cols-12 gap-6 lg:gap-8">
                                <div className="col-span-12 lg:col-span-8 min-w-0 flex flex-col gap-6">
                                    ...
                                    <div className="card p-0 overflow-hidden border-top-4 border-primary">
                                        <div className="card-header">
                                            <h3 className="mb-0 text-sm font-black uppercase tracking-wider">Institutional Grading</h3>
                                            <Button variant="outline" size="sm" onClick={() => setIsGradeModalOpen(true)} icon={<Plus size={14} />}>NEW SYSTEM</Button>
                                        </div>
                                ...
                                <div className="col-span-12 lg:col-span-4 min-w-0">
                                    <div className="card p-0 overflow-hidden border-top-4 border-primary sticky top-4">
