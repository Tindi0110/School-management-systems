            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-8 no-print">
                ...
                {!isReadOnly && (
                    <div className="flex flex-wrap gap-2 w-full lg:w-auto mt-2 lg:mt-0">
                        ...
                        <Button variant="ghost" className="text-[10px] font-black uppercase tracking-widest opacity-60 text-amber-600" onClick={() => { if(confirm("Recalculate ALL student fee balances from scratch? This is intensive.")) studentsAPI.syncAllBalances().then((r: any) => success(`Sync Complete: ${r.data.updated_count} students updated`)); }} icon={<TrendingUp size={14} />}>Sync Balances</Button>
