...
INSTALLED_APPS = [
    ...
    'whitenoise.runserver_nostatic', # Whitenoise above staticfiles
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'static'), os.path.join(FRONTEND_DIR, 'dist')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {
        'NAME': 'sms.validators.ComplexityValidator',
    },
]
...
TIME_ZONE = 'Africa/Nairobi' # Kenyan School
...
EMAIL_USE_SSL = (os.getenv('MAIL_USE_SSL') or os.getenv('EMAIL_USE_SSL', 'False')) == 'True'
