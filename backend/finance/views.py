...
class InvoiceViewSet(viewsets.ModelViewSet):
    ...
    def dashboard_stats(self, request):
        ...
        # Get recent invoices & payments from the SAME filtered context
        ...
        ).order_by('-date_received', '-id')[:5]
        
        recent_data = InvoiceSerializer(recent_invoices, many=True).data
        recent_pay_data = PaymentListSerializer(recent_payments, many=True).data
    ...
    def generate_batch(self, request):
        ...
        try:
            ...
            with transaction.atomic():
                ...
                # Bust the finance dashboard cache so the new data shows immediately
...
class PaymentViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        # Auto-set User and bust finance dashboard cache
